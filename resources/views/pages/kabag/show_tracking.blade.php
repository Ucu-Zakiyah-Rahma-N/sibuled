...
<a href="{{ url('kabag/tracking') }}" class="btn btn-secondary mb-3">
...
<div class="card shadow-sm">
    <div class="card-body">
        <h4 class="mb-4 text-primary">
            <i class="ti ti-mail"></i> Detail Tracking Surat 
        </h4>
        ...
        <div class="mb-3">
            ...
            <a href="{{ url('surat_keluar/download', $surat->id) }}" class="btn btn-outline-primary mt-3">
