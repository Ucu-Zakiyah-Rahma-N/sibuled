...
<style>
    ...
    .page {
        ...
        background-image: url('{{ public_path("assets/images/template_SPH.png") }}');
...
<div class="container-fluid">
    <div class="card shadow">
            ...
            <table class="table table-bordered table-sm bg-white mt-3">
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $luas = [];
                            if($quotation->luas_slf) $luas[] = "SLF: {$quotation->luas_slf} m²";
                            if($quotation->luas_pbg) $luas[] = "PBG: {$quotation->luas_pbg} m²";
                            if($quotation->luas_shgb) $luas[] = "SHGB: {$quotation->luas_shgb} m²";
                        @endphp
            ...
            <div class="mt-4">
                ...
                <div style="margin-top: 10px; text-align: left;">
                    ...
                    <div style="position: relative; width: 260px; height: 150px; margin-top: 5px;">
                        <img src="{{ public_path('assets/images/ttd_pak_jejen.png') }}"
                             style="position: absolute; left: 0; top: -10px; width: 110px; z-index: 3;">
                        <img src="{{ public_path('assets/images/stempel_simply.png') }}"
                             style="position: absolute; left: 55px; top: 10px; width: 85px; opacity: .8; z-index: 2;">
                    </div>
        ...
        <div class="page">
            ...
            <p>
                Jangka waktu Pengurusan {{ $jenisText }} : {{ $quotation->lama_pekerjaan }} Hari
            </p>
